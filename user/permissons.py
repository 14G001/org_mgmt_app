...
def get_user_models_permissons(app_section_types, user_types_to_exclude):
...
def get_root_user_type_permissons(app_section_types):
    return get_user_models_permissons(app_section_types, ["root"        ])
def get_admin_user_type_permissons(app_section_types):
    return get_user_models_permissons(app_section_types, ["root","admin"])